...
```{r ohp-page3361, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
...
```{r ohp-page3362, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
...
```{r ohp-page3366, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
#rmdhelp::use_odg_graphic(ps_path = 'odg/ohp-page3366.odg')
knitr::include_graphics(path = "odg/ohp-page3366.png")
# fs::file_delete(path = '~/Desktop/IMG_3366.jpg')
```
...
```{r ohp-page3368, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
...
```{r ohp-page3369, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
...
```{r ohp-page3372, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="75%"}
